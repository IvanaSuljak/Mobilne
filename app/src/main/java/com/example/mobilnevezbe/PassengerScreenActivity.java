...
/**
 * VEZBA 6: Ekran koji se prikazuje korisniku sa ulogom "putnik".
 * Prikazuje informacije i opcije relevantne za putnika.
 */
public class PassengerScreenActivity extends AppCompatActivity {

    private static final String TAG = "PassengerScreenActivity";
    ...
    private void initViews() {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Ekran Putnika");
        }
    }
    ...
    private void prikaziPodatke() {
        // VEZBA 6: Podaci iz SharedPreferences
